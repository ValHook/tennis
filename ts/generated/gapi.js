...
export function Export(rosters, callback) {
    ...
    try {
        ...
        rosters.forEach((roster, index) => {
            ...
            roster.rotations?.forEach((rotation) => {
                rotation.resting_players.forEach((player, number) => {
                    let row = {
                        values: [
                            {
                                userEnteredValue: {
                ...
                rotation.singles.forEach((single, number) => {
                    let row = {
                        values: [
                            {
                                userEnteredValue: {
                ...
                rotation.doubles.forEach((double, number) => {
                    let row = {
                        values: [
                            {
                                userEnteredValue: {
